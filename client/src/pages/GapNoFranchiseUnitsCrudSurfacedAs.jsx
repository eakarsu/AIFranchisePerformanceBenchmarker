...
// Auto-generated page for: No franchise-units CRUD surfaced as named route (only via cr

export default function GapNoFranchiseUnitsCrudSurfacedAs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-franchise-units-crud-surfaced-as', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No franchise-units CRUD surfaced as named route (only via cr</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No franchise-units CRUD surfaced as named route (only via crudFactory)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No franchise-units CRUD surfaced as named route (only via cr'}
        </button>
      </form>
