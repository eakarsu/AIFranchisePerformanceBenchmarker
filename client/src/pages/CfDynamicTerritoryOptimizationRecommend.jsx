...
// Auto-generated page for: Dynamic territory optimization recommending unit consolidati

export default function CfDynamicTerritoryOptimizationRecommend() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-dynamic-territory-optimization-recommend', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Dynamic territory optimization recommending unit consolidati</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Dynamic territory optimization recommending unit consolidation/expansion based on demographic + operational data.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Dynamic territory optimization recommending unit consolidati'}
        </button>
      </form>
