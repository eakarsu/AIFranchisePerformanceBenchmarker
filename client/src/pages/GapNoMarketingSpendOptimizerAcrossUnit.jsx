...
// Auto-generated page for: No marketing spend optimizer across units

export default function GapNoMarketingSpendOptimizerAcrossUnit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-marketing-spend-optimizer-across-unit', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No marketing spend optimizer across units</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No marketing spend optimizer across units</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No marketing spend optimizer across units'}
        </button>
      </form>
