...
// Auto-generated page for: Brand-standard photo audit via vision models analyzing in-st

export default function CfBrandStandardPhotoAuditViaVision() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-brand-standard-photo-audit-via-vision', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Brand-standard photo audit via vision models analyzing in-st</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Brand-standard photo audit via vision models analyzing in-store imagery against franchisor SOPs.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Brand-standard photo audit via vision models analyzing in-st'}
        </button>
      </form>
