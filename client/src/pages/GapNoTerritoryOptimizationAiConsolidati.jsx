...
// Auto-generated page for: No territory-optimization AI (consolidation/expansion zone r

export default function GapNoTerritoryOptimizationAiConsolidati() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-territory-optimization-ai-consolidati', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No territory-optimization AI (consolidation/expansion zone r</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No territory-optimization AI (consolidation/expansion zone recommendations)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No territory-optimization AI (consolidation/expansion zone r'}
        </button>
      </form>
