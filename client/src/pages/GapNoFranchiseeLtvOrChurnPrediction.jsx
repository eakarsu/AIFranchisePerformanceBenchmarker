...
// Auto-generated page for: No franchisee LTV or churn prediction

export default function GapNoFranchiseeLtvOrChurnPrediction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-franchisee-ltv-or-churn-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No franchisee LTV or churn prediction</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No franchisee LTV or churn prediction</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No franchisee LTV or churn prediction'}
        </button>
      </form>
